...
class Child:public Base {
  ...
  Child(const Member &m, myClass *obj1_, std::unique_ptr<myClass> obj2_ = nullptr):mem(m):obj1(obj1_):obj2(std::move(obj2_)) { 

  }

  //copy constructor
  Child(const Child &other) : Base(other), mem(other.mem), obj1(nullptr), obj2(nullptr) {
    if(other.obj1) {
